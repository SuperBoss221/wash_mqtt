...
def get_machine_status():
    ...
    return ujson.dumps({"app":"wash","status":"error","error":"Failed to read machine status","raw_data":status_data,"error_data":status_error})

    #return ujson.dumps({"error": "Failed"})
