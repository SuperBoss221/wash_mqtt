...
def get_machine_status():
    ...
    return ujson.dumps({"app":"dryer","status":"error","error":"Failed to Dryer V1","raw_data":status_data,"error_data":status_error})
...
def stop_operation():
    if modbus_client.write_multiple_registers(2, [1]):
